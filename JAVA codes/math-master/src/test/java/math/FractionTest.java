...
public class FractionTest {
	...
	public void testFractionIntInt() {
		...
		assertThrows(ArithmeticException.class, () -> new Fraction(11, 0));
	}
	...
	public void testSubstractInt() {
		...
		assertFraction(-154, 53, f.substract(5));
		assertFraction(164, 53, f.substract(-1));
	}
	...
	public void testSubstractFraction() {
		Fraction f = new Fraction(12, 17);
		assertFraction(11, 17, f.substract(new Fraction(1, 17)));
		assertFraction(7, 34, f.substract(new Fraction(1, 2)));
	}
	...
	public void testDoubleValue() {
		assertEquals(((double) 1) / 3, new Fraction(1, 3).doubleValue(), 1E-10);
		assertEquals(((double) 123456) / 101, new Fraction(123456, 101).doubleValue(), 1E-10);
	}

	@Test
	public void testFloatValue() {
		assertEquals(((float) 1) / 3, new Fraction(1, 3).floatValue(), 1E-10);
		assertEquals(((float) 123456) / 101, new Fraction(123456, 101).floatValue(), 1E-10);
	}
